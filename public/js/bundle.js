    ...
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            API.requestAPI("".concat(API.userEndpoint, "/signup/").concat(tempUserId, "/").concat(verificationToken), 'POST', {
              name: data[0],
              password: data[1],
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              _utils.Utils.dispatchTimer(function () {
                ...
                _loader.Loader.showAlert('success', "".concat(res.data.message, " Redirecting..."));
