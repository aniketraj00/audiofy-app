...
_defineProperty(Alert, "showAlert", function (type, msg) {
  Alert.hideAlert();
...
_defineProperty(Alert, "hideAlert", function () {
  $('#alert').modal('hide');
});
...
_defineProperty(Loader, "showLoader", function (msg) {
  $('#loader-text').text(msg);
  $('#loader').modal('show');
});

_defineProperty(Loader, "hideLoader", function () {
  $('#loader').modal('hide');
});
...
_defineProperty(Utils, "formatTrackTitleString", function (title) {
  var fTitle = title.split('Audiofy')[0];
...
_defineProperty(Utils, "formatArtistString", function (str) {
  if (str.length > 20) {
    str = str.substr(0, 20);
...
_defineProperty(Utils, "parseDuration", function (dur) {
  var durationInt = Math.floor(dur);
  var minutes = Math.floor(durationInt / 60);
  var seconds = durationInt % 60;
  if ("".concat(minutes).length === 1) minutes = "0".concat(minutes);
  if ("".concat(seconds).length === 1) seconds = "0".concat(seconds);
  return "".concat(minutes, ":").concat(seconds);
});

_defineProperty(Utils, "dispatchTimer", function (fn, time) {
  return setTimeout(fn, time);
});

_defineProperty(Utils, "formatAlbumTitle", function (albumTitle) {
  var title = albumTitle.split('-')[0];
  if (title.length > 15) return "".concat(title.substr(0, 15), "...");
  return title;
});

_defineProperty(Utils, "getPaginationRange", function (page) {
  var min = page;
  var max = page;
...
_defineProperty(Utils, "calcPercent", function (val, total) {
  return Math.floor(val / total * 100);
});

_defineProperty(Utils, "getPageId", {
  index: 0,
  albums: 1,
  tracks: 2,
  user_account: 3,
...
module.exports = {
  ...
  "_spec": "axios@0.21.4",
  "_where": "C:\\Users\\ANIKET\\Documents\\Web_Dev WorkSpace\\NodeJS Projects\\audiofy",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
_defineProperty(API, "albumEndpoint", '/api/v1/albums');

_defineProperty(API, "trackEndpoint", '/api/v1/tracks');

_defineProperty(API, "userEndpoint", '/api/v1/users');

_defineProperty(API, "adminEndpoint", '/admin');

_defineProperty(API, "requestAPI", function (url, method, data) {
...
_defineProperty(API, "getAlbums", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return API.requestAPI("".concat(API.albumEndpoint, "?page=").concat(page), 'GET', null);
...
_defineProperty(API, "getAlbumSearchResult", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(query, page) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return API.requestAPI("".concat(API.albumEndpoint, "/search?").concat(query, "&page=").concat(page), 'GET', null);
...
_defineProperty(API, "getAlbum", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return API.requestAPI("".concat(API.albumEndpoint, "/").concat(id), 'GET', null);
...
_defineProperty(API, "getForgotPassword", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return API.requestAPI("".concat(API.userEndpoint, "/forgotPassword"), 'POST', {
              email: email
            });
...
_defineProperty(API, "getResetPassword", /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(resetToken, data) {
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return API.requestAPI("".concat(API.userEndpoint, "/resetPassword/").concat(resetToken), 'POST', {
              password: data[0],
...
_defineProperty(API, "getLogin", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return API.requestAPI("".concat(API.userEndpoint, "/login"), 'POST', {
              email: email,
              password: password
            });
...
_defineProperty(API, "getLogout", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
  return regeneratorRuntime.wrap(function _callee7$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return API.requestAPI("".concat(API.userEndpoint, "/logout"), 'GET', null);
...
_defineProperty(API, "getSignupVerify", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return API.requestAPI("".concat(API.userEndpoint, "/signup"), 'POST', {
              email: email
            });
...
_defineProperty(API, "getSignup", /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(tempUserId, verificationToken, data) {
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            return _context9.abrupt("return", API.requestAPI("".concat(API.userEndpoint, "/signup/").concat(tempUserId, "/").concat(verificationToken), 'POST', {
              name: data[0],
              password: data[1],
...
_defineProperty(API, "getSignAndUpload", /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(file, fileName, fileType) {
    var sign, signedResponse;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.prev = 0;
            _context10.next = 3;
            return API.requestAPI("".concat(API.adminEndpoint, "/auth/sign-s3"), 'POST', {
              fileName: fileName,
              fileType: fileType
            });
          ...
          case 3:
            ...
            signedResponse = JSON.parse(sign.data.signedResponse);
            _context10.next = 7;
            return API.requestAPI(signedResponse.signedUrl, 'PUT', file);

          case 7:
            return _context10.abrupt("return", signedResponse.fileUrl);
...
_defineProperty(API, "getUploadTrack", /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(tracks) {
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            _context11.next = 2;
            return API.requestAPI(API.trackEndpoint, 'POST', tracks);
...
_defineProperty(API, "getUploadAlbum", /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(albumDoc) {
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            _context12.prev = 0;
            _context12.next = 3;
            return API.getUploadTrack(albumDoc.tracks);

          case 3:
            albumDoc.tracks = _context12.sent.data.data.doc.map(function (el) {
              return el._id;
            });
            _context12.next = 6;
            return API.requestAPI(API.albumEndpoint, 'POST', albumDoc);
...
},{"axios":"../../node_modules/axios/index.js"}],"authenticator.js":[function(require,module,exports) {
"use strict";
...
_defineProperty(Authenticator, "errorHandler", function (errMsg, time) {
  /**
   ...
   */
  return _utils.Utils.dispatchTimer(function () {
    _loader.Loader.hideLoader();

    _alert.Alert.showAlert('error', errMsg);
  }, time);
});

_defineProperty(Authenticator, "forgotPassword", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _loader.Loader.showLoader('Sending Verification Email...');

            _context.prev = 1;
            _context.next = 4;
            return _api.API.getForgotPassword(email);

          case 4:
            res = _context.sent;

            if (res.data.status === 'success') {
              _utils.Utils.dispatchTimer(function () {
                _loader.Loader.hideLoader();

                _alert.Alert.showAlert('success', res.data.message);
              }, 1000);
            }
          ...
          case 8:
            ...
            Authenticator.errorHandler(_context.t0.response.data.message, 1000);
...
_defineProperty(Authenticator, "resetPassword", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(resetToken) {
    var _len,
        data,
        _key,
        res,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _loader.Loader.showLoader('Updating Password...');

            _context2.prev = 1;

            for (_len = _args2.length, data = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
              data[_key - 1] = _args2[_key];
            }

            _context2.next = 5;
            return _api.API.getResetPassword(resetToken, data);
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              _utils.Utils.dispatchTimer(function () {
                ...
                _alert.Alert.showAlert('success', "".concat(res.data.message, " Redirecting..."));
          ...
          case 9:
            ...
            Authenticator.errorHandler(_context2.t0.response.data.message, 1000);
...
_defineProperty(Authenticator, "login", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _loader.Loader.showLoader('Logging in...');

            _context3.next = 4;
            return _api.API.getLogin(email, password);
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              _utils.Utils.dispatchTimer(function () {
                ...
                _alert.Alert.showAlert('success', 'Logged in successfully! Redirecting...');
          ...
          case 8:
            ...
            Authenticator.errorHandler(_context3.t0.response.data.message, 1000);
...
_defineProperty(Authenticator, "logout", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
  var res;
  return regeneratorRuntime.wrap(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _loader.Loader.showLoader('Logging out...');

          _context4.next = 4;
          return _api.API.getLogout();
        ...
        case 8:
          ...
          Authenticator.errorHandler(_context4.t0.response.data.message, 1000);
...
_defineProperty(Authenticator, "signupVerify", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _loader.Loader.showLoader('Sending Confirmation Email...');

            _context5.next = 4;
            return _api.API.getSignupVerify(email);
          ...
          case 8:
            ...
            Authenticator.errorHandler(_context5.t0.response.data.message, 1000);
...
_defineProperty(Authenticator, "signup", /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(tempUserId, verificationToken) {
    var _len2,
        data,
        _key2,
        res,
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _loader.Loader.showLoader('Signing Up...');

            for (_len2 = _args6.length, data = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
              data[_key2 - 2] = _args6[_key2];
            }

            _context6.next = 5;
            return _api.API.getSignup(tempUserId, verificationToken, data);
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              _utils.Utils.dispatchTimer(function () {
                ...
                _alert.Alert.showAlert('success', 'Registered successfully! Redirecting...');
          ...
          case 10:
            ...
            Authenticator.errorHandler(_context6.t0.response.data.message, 1000);
...
},{"./alert":"alert.js","./loader":"loader.js","./utils":"utils.js","./api":"api.js"}],"Utils.js":[function(require,module,exports) {
"use strict";
...
var Views = /*#__PURE__*/function () {
  ...
  _createClass(Views, null, [{
    key: "renderTrackListItemView",
    value: //Current pages can have values like HOME,ALBUMS,TRACKS,USER_ACCOUNT
    function renderTrackListItemView(track) {
      return "<a style='cursor: pointer' class='list-group-item list-group-item-action trackItem' data-uid='".concat(track._id, "'>\n                    <div class='d-flex w-100 justify-content-between'>\n                        <div>\n                            <p class='mb-1'><strong>").concat(track.title, "</strong></p>\n                            <p class='mb-1'>").concat(track.artists, "</p>\n                            <small>").concat(_utils.Utils.parseDuration(track.duration), "</small>\n                        </div>\n                        <button class='btn btn-transparent align-self-center optionsBtn'><i class='fas fa-ellipsis-v'></i></button>\n                    </div>   \n                </a>");
    }
  }, {
    key: "renderTrackListView",
    value: function renderTrackListView(targetAlbum) {
      return "<div class='row cc-animation-slideIn-1x tracksView mb-4'>\n                    <div class='col-12'>\n                        <button class='btn btn-transparent text-light mb-2' id='tracksViewBackBtn'>\n                            <i class='fas fa-chevron-left'></i> Back\n                        </button>\n                    </div>\n                    <div class='col-12 col-sm-6 col-md-4'>\n                        <div class='card text-center cc-rounded'>\n                            <div class='card-body text-secondary'>\n                                <img src='".concat(targetAlbum.cover, "' alt='").concat(targetAlbum.name, "-cover' class='cc-rounded' style='max-width: 100%;'>\n                                <h5 class='card-title mt-3 mb-1'>").concat(targetAlbum.name, "</h5>\n                                <p class='card-text mb-1'>").concat(targetAlbum.genre, "</p>\n                                <p class='card-text mb-0'>").concat(targetAlbum.year, "</p>\n                            </div>\n                        </div>\n                    </div>\n                    <div class='col-12 col-sm-6 mt-3 mt-sm-0'>\n                         <div class=\"list-group cc-rounded\">\n                            ").concat(targetAlbum.tracks.map(function (track) {
        return Views.renderTrackListItemView(track);
      }).join(''), "\n                        </div>\n                    </div>\n                </div>");
    }
  }, {
    key: "renderPlayerView",
    value: function renderPlayerView(albumCover, albumName, trackTitle, trackArtists) {
      return "<div class=\"playerView cc-animation-slideUp-1x\">\n                    <div class=\"playerView__info\">\n                        <div class=\"playerView__info-thumbnail\">\n                            <img src=\"".concat(albumCover, "\" alt=\"").concat(albumName, "-cover\" id=\"playerView__info-thumbnail-pic\">\n                            <div class=\"img-backdrop\">\n                                <div class=\"spinner-border text-primary\" role=\"status\">\n                                    <span class=\"sr-only\">Loading...</span>\n                                </div>\n                            </div>\n                        </div>\n                        <div class=\"playerView__infometa ml-3 text-secondary\">\n                            <p class=\"mb-0\"><strong id=\"playerView__infometa-title\">").concat(_utils.Utils.formatTrackTitleString(trackTitle), "</strong></p>\n                            <p class=\"small mb-0\" id=\"playerView__infometa-artist\">").concat(_utils.Utils.formatArtistString(trackArtists), "</p>\n                        </div>\n                    </div>\n                    <div class=\"playerView__content text-center\">\n                        <div class=\"btn-group\" role=\"group\">\n                            <button type=\"button\" class=\"btn btn-transparent\"><i id=\"prevTrackBtn\" class=\"fas fa-step-backward\"></i></button>\n                            <button type=\"button\" class=\"btn btn-transparent\"><i id=\"playPauseBtn\" class=\"fas fa-play\"></i></button>\n                            <button type=\"button\" class=\"btn btn-transparent\"><i id=\"nextTrackBtn\" class=\"fas fa-step-forward\"></i></button>\n                            <button type=\"button\" class=\"btn btn-transparent\"><i id=\"likeSongBtn\" class=\"far fa-heart\"></i></button>\n                        </div>\n                        <div class=\"playerView__content-seekbarView text-dark d-flex\">\n                            <span class=\"small mr-2\" id=\"curTimeView\">00:00</span>\n                            <input type=\"range\" class=\"form-range\" id=\"seekbar\">\n                            <span class=\"small ml-2\" id=\"totalTimeView\">00:00</span>\n                        </div>\n                    </div>\n                </div>");
    }
  }, {
    key: "resetActiveTrackView",
    value: function resetActiveTrackView() {
      return Array.from(document.querySelectorAll('.trackItem')).map(function (el) {
        el.classList.remove('active');
        return el;
      });
    }
  }, {
    key: "renderActiveTrackView",
    value: function renderActiveTrackView() {
      var _this = this;

      if (this.activeTrack && this.activePage === _utils.Utils.getPageId.tracks) {
        this.resetActiveTrackView().forEach(function (el) {
          if (el.dataset.uid === _this.activeTrack) {
...
_defineProperty(Views, "activePage", void 0);

_defineProperty(Views, "activeTrack", void 0);

_defineProperty(Views, "renderHeadingView", function (headingTitle) {
  return "<div class='row'>\n                    <div class='col-12'>\n                        <h5 class='display-4 mb-2 ml-2'>".concat(headingTitle, "</h5>\n                        <hr class='bg-light mt-0 mb-4'>\n                    </div>\n                </div>");
});

_defineProperty(Views, "renderAlbumCardView", function (album) {
  return "<a href='#' class='list-group-item list-group-item-action albumItem' data-uid='".concat(album._id, "'>\n                    <div class='d-flex w-100 justify-content-start'>\n                        <img class='mr-3 align-self-center' src='").concat(album.cover, "' alt='").concat(album.name, "-cover' style='max-width: 60px; max-height: 60px'>\n                        <div>\n                            <h5 class='card-title mb-1'>").concat(album.name, "</h5>\n                            <p class='mb-0'>").concat(album.year, " | ").concat(album.tracks.length, " Songs</p>\n                            <p class='mb-0'>").concat(album.genre, "</p>\n                        </div>\n                    </div>\n                </a>");
});

_defineProperty(Views, "renderAlbumView", function (albums) {
  if (albums.length === 0) return Views.renderNoContentView();
  var markup = "<div class='list-group mb-4 albumsView cc-animation-slideIn-1x'>";
...
_defineProperty(Views, "renderNoContentView", function () {
...
_defineProperty(Views, "renderPaginationEl", function (page, active) {
  return "<li class='page-item c-link".concat(active ? ' active' : '', "' id='").concat(page, "'>\n                    <a class='page-link' tabindex='-1'>").concat(page, "</a>\n                </li>");
});

_defineProperty(Views, "renderPaginationGroup", function (curPage, lowerBound, upperBound) {
  var markup = '';

  for (var i = lowerBound; i <= upperBound; i++) {
    if (i === curPage) markup += Views.renderPaginationEl(i, true);else markup += Views.renderPaginationEl(i, false);
  }

  return markup;
});

_defineProperty(Views, "renderPaginationView", function (curPage, totalPageCount) {
  var markup = '';

  if (curPage % 5 === 1) {
    markup += Views.renderPaginationGroup(curPage, curPage, Math.min(curPage + 4, totalPageCount));
  } else {
    var _Utils$getPaginationR = _utils.Utils.getPaginationRange(curPage),
        _Utils$getPaginationR2 = _slicedToArray(_Utils$getPaginationR, 2),
        min = _Utils$getPaginationR2[0],
        max = _Utils$getPaginationR2[1];

    markup += Views.renderPaginationGroup(curPage, min, Math.min(max, totalPageCount));
  }

  return "<nav>\n                    <ul class='pagination pagination-sm justify-content-center pagination__main'>\n                        <li class='page-item".concat(curPage === 1 ? ' disabled' : ' c-link', "' id='prev'>\n                            <a class='page-link' tabindex='-1'>Previous</a>\n                        </li>\n                        ").concat(markup, "\n                        <li class='page-item").concat(curPage === totalPageCount ? ' disabled' : ' c-link', "' id='next'>\n                            <a class='page-link' tabindex='-1'>Next</a>\n                        </li>\n                    </ul>\n                </nav>");
});

_defineProperty(Views, "renderSearchBarView", function () {
...
_defineProperty(Views, "renderAlbumSearchView", function (albums) {
  return "<div id='searchView'>\n                    <div class='row".concat(albums.length === 0 ? ' mb-5' : '', "'>\n                        <div class='col-12'>\n                            <button class='btn btn-transparent text-light mb-2' id='searchViewBackBtn'>\n                                <i class='fas fa-chevron-left'></i> Albums\n                            </button>\n                        </div>\n                    </div>\n                    ").concat(albums.length === 0 ? Views.renderNoContentView() : Views.renderAlbumView(albums), "\n                </div>");
});

_defineProperty(Views, "renderUploadTrackView", function (tracks) {
  return tracks.map(function (track, idx) {
    return "<div class=\"form-group\">\n                                <label for=\"trackDetails\">Track #".concat(idx + 1, "</label>\n                                <div id=\"trackDetails\">\n                                    <input type=\"text\" class=\"form-control r-bl-0 r-br-0 bb-0 trackTitleInput\" value=\"").concat(track.title, "\" required>\n                                    <input type=\"text\" class=\"form-control r-tl-0 r-tr-0 trackArtistsInput\" value=\"").concat(track.artists, "\" required>\n                                </div>\n                            </div>");
  }).join('');
});

_defineProperty(Views, "renderUploadAlbumView", function (album) {
  return "<div class='col-12 col-md-6 col-lg-4'>\n                    <div class=\"card mb-2\">\n                        <div class=\"card-body\">\n                            <form class=\"text-dark\">\n                                <img id=\"albumUpload__cover\" class=\"img-thumbnail bb-0 r-bl-0 r-br-0\" src=\"data:image/jpg;base64,".concat(album.cover.toString('base64'), "\" alt=\"").concat(album.name, "-cover\">\n                                <div class=\"custom-file mb-3\">\n                                    <input type=\"file\" class=\"custom-file-input\" id=\"albumCoverSelector\" accept='image/*'>\n                                    <label class=\"custom-file-label r-tl-0 r-tr-0\" for=\"albumCoverSelector\">Choose album cover</label>\n                                </div>\n                                <div class=\"form-group\">\n                                    <label for=\"albumName\">Name: </label>\n                                    <input type=\"text\" class=\"form-control\" id=\"albumName\" value=\"").concat(album.name, "\" required>\n                                </div>\n                                <div class=\"form-group\">\n                                    <label for=\"albumGenre\">Genre: </label>\n                                    <input type=\"text\" class=\"form-control\" id=\"albumGenre\" value=\"").concat(album.genre, "\" required>\n                                </div>\n                                <div class=\"form-group\">\n                                    <label for=\"albumYear\">Released In: </label>\n                                    <input type=\"text\" class=\"form-control\" id=\"albumYear\" value=\"").concat(album.year, "\" required>\n                                </div>\n                            </form>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-12 col-md-6 col-lg-4 mt-2 mt-md-0\">\n                    <div class=\"card\">\n                        <div class=\"card-body\">\n                            <form class=\"text-dark\">\n                                ").concat(Views.renderUploadTrackView(album.tracks), "\n                                <input class=\"btn btn-primary btn-sm btn-block mt-3 form__upload-final--btn bg-primary\" type=\"button\" value=\"Upload\"> \n                                <input class=\"btn btn-primary btn-sm btn-block mt-2 form__upload-cancel--btn bg-primary\" type=\"button\" value=\"Cancel\">\n                            </form>\n                        </div>\n                    </div>\n                </div>");
});
},{"./utils":"utils.js"}],"player.js":[function(require,module,exports) {
"use strict";
...
var AudioPlayer = /*#__PURE__*/function () {
  ...
  _createClass(AudioPlayer, null, [{
    ...
    key: "resetPlayerTimerView",
    value: function resetPlayerTimerView() {
      AudioPlayer.playerCurTimeView.textContent = '00:00';
      AudioPlayer.playerTotalTimeView.textContent = '00:00';
    }
  }, {
    key: "initPrevTrackBtn",
    value: function initPrevTrackBtn() {
    ...
    key: "initNextTrackBtn",
    value: function initNextTrackBtn() {
    ...
    key: "setPauseBtnView",
    value: function setPauseBtnView() {
    ...
    value: function updatePlayer() {
      var trackCoverView = AudioPlayer.playerView.querySelector('#playerView__info-thumbnail-pic');
      var trackTitleView = AudioPlayer.playerView.querySelector('#playerView__infometa-title');
      var trackArtistView = AudioPlayer.playerView.querySelector('#playerView__infometa-artist');
      var imgBackdropView = AudioPlayer.playerView.querySelector('.img-backdrop');
      var curTrack = AudioPlayer.curPlaylist[AudioPlayer.curTrackIdx];
      _views.Views.activeTrack = curTrack._id;
      trackCoverView.src = curTrack.cover;
      trackCoverView.alt = "".concat(curTrack.title, "-cover");
      trackTitleView.textContent = _utils.Utils.formatTrackTitleString(curTrack.title);
      trackArtistView.textContent = _utils.Utils.formatArtistString(curTrack.artists);
      imgBackdropView.style = 'display: flex;';

      _views.Views.renderActiveTrackView();
    ...
    key: "onReadyToPlayHandler",
    value: function onReadyToPlayHandler() {
      AudioPlayer.playerView.querySelector('.img-backdrop').style = 'display: none;';
      AudioPlayer.playerTotalTimeView.textContent = _utils.Utils.parseDuration(AudioPlayer.controls.seekbar.max);
      AudioPlayer.setPauseBtnView();
    }
  }, {
    key: "onTimeUpdateHandler",
    value: function onTimeUpdateHandler() {
      AudioPlayer.playerCurTimeView.textContent = _utils.Utils.parseDuration(AudioPlayer.player.currentTime);
    ...
    key: "prevTrackHandler",
    value: function prevTrackHandler() {
    ...
    value: function nextTrackHandler() {
    ...
    key: "onSeekedHandler",
    value: function () {
      var _onSeekedHandler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return AudioPlayer.player.play();
      ...
      function onSeekedHandler(_x) {
        return _onSeekedHandler.apply(this, arguments);
      }

      return onSeekedHandler;
    }()
  }, {
    key: "initPlayer",
    value: function initPlayer(playerView, curPlaylistDomArr, curPlaylistId, curPlaylist, curTrackIdx, autoPlay) {
      /**
      ...
      AudioPlayer.initPrevTrackBtn();
      AudioPlayer.initNextTrackBtn(); //Setup play and pause control handlers

      AudioPlayer.controls.playPauseBtn.addEventListener('click', AudioPlayer.playPauseHandler); //Setup seekbar control handler
      ...
      AudioPlayer.initSeekbar(); //TODO: Setup like song button handler
...
_defineProperty(AudioPlayer, "player", new Audio());

_defineProperty(AudioPlayer, "isActive", void 0);

_defineProperty(AudioPlayer, "playerView", void 0);

_defineProperty(AudioPlayer, "playerCurTimeView", void 0);

_defineProperty(AudioPlayer, "playerTotalTimeView", void 0);

_defineProperty(AudioPlayer, "controls", {});

_defineProperty(AudioPlayer, "curPlaylist", void 0);

_defineProperty(AudioPlayer, "curPlaylistId", void 0);

_defineProperty(AudioPlayer, "curPlaylistSize", void 0);

_defineProperty(AudioPlayer, "curTrackIdx", void 0);

_defineProperty(AudioPlayer, "curPlaylistDomArr", void 0);
},{"./utils":"utils.js","./views":"views.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var sidebarOpenBtn = document.querySelector('.sidebar-toggler--open');
var sidebarCloseBtn = document.querySelector('.sidebar-toggler--close');
var sidebar = document.querySelector('.sidebar');
var sidebarMenu = document.querySelector('.sidebar-menu');
var sidebarHomeBtn = document.getElementById('sidebar__homeBtn');
var sidebarAlbumsBtn = document.getElementById('sidebar__albumBtn');
var sidebarUserAccountBtn = document.getElementById('sidebar__accountBtn');
var headingViewContainer = document.getElementById('headingContainer');
var searchBarViewContainer = document.getElementById('searchBarViewContainer');
var contentViewContainer = document.getElementById('contentViewContainer');
var paginationViewContainer = document.getElementById('paginationViewContainer');
var playerContainer = document.getElementById('playerContainer');
var passResetVerifyForm = document.querySelector('.form__passReset-verify');
var passResetForm = document.querySelector('.form__passReset');
var loginForm = document.querySelector('.form__login');
var logoutBtns = document.querySelectorAll('.logoutBtn');
var signupVerifyForm = document.querySelector('.form__signup-verify');
var signupForm = document.querySelector('.form__signup');

var changeDocTitle = function changeDocTitle(title) {
  document.title = "Audiofy | Largest Music Library | ".concat(title);
};

var sidebarOpenEvtCallback = function sidebarOpenEvtCallback() {
  sidebar.classList.add('slide-in');
};

var sidebarCloseEvtCallback = function sidebarCloseEvtCallback() {
  sidebar.classList.remove('slide-in');
};

var toggleActiveTab = function toggleActiveTab(activeTab) {
  contentViewContainer.dataset.active = activeTab;
  Array.from(sidebarMenu.children).forEach(function (child) {
...
var clearPageView = function clearPageView() {
...
if (sidebarHomeBtn) sidebarHomeBtn.addEventListener('click', function () {
  loadIndexView();
});
if (sidebarAlbumsBtn) sidebarAlbumsBtn.addEventListener('click', function () {
  loadAlbumView(1);
});
if (sidebarUserAccountBtn) sidebarUserAccountBtn.addEventListener('click', function () {
  loadUserAccountView();
}); //Album and player related event listeners

var getPaginationEvtCallback = function getPaginationEvtCallback(curPage, totalPageCount, targetViewLoaderCallback) {
  return function (event) {
    //Get the target page no.
    var pageId;
    if (event.target.tagName === 'LI') pageId = event.target.id;else if (event.target.tagName === 'A') pageId = event.target.parentElement.id;else return; //Load the target page view
...
var getAlbumSearchEvtCallback = function getAlbumSearchEvtCallback() {
  return function () {
    ...
    var searchVal = document.getElementById('main__search-input').value;
    var searchBy = searchOptions[document.getElementById('main__search-select').value];
    var query = "".concat(searchBy, "=").concat(searchVal); //Return if search field is empty

    if (searchVal === '') return; //Save the query.

    document.body.dataset.qstr = query; //Load the search view.

    loadSearchView(1, query);
  };
};

var loadSearchBarView = function loadSearchBarView() {
  //Geneate search view.
  var searchView = _views.Views.renderSearchBarView(); //Insert the search view into its container.


  searchBarViewContainer.innerHTML = searchView; //Attach event listener to the search button.

  document.querySelector('.main__search-btn').addEventListener('click', getAlbumSearchEvtCallback());
};

var loadPlayer = function loadPlayer(targetAlbum) {
  return function (e) {
    //Save the event target object
    var targetEl = e.target; //Prevent loading the player in case the options button on the track DOM element is clicked
    ...
    if (!targetEl.classList.contains('trackItem')) return; //Build the playlist i.e. array of the track DOM elements

    var playlistDOMArr = Array.from(document.querySelectorAll('.trackItem')); //Get the index of the target track DOM element from the tracks DOM array

    var idx = playlistDOMArr.indexOf(targetEl); //Build the playlist out of the current album

    var playlist = targetAlbum.tracks.map(function (track) {
      track.cover = targetAlbum.cover;
      track.albumName = targetAlbum.name;
      return track;
    }); //Render the player view using the target track's metadata

    var playerView = _views.Views.renderPlayerView(playlist[idx].cover, playlist[idx].albumName, playlist[idx].title, playlist[idx].artists);

    playerContainer.innerHTML = playerView; //Initialize the player

    _views.Views.activeTrack = playlist[idx]._id;

    _player.AudioPlayer.initPlayer(playerContainer.firstChild, playlistDOMArr, targetAlbum._id, playlist, idx, true);
  };
};

var loadPaginationView = function loadPaginationView(curPage, totalPageCount, paginationEvtCallback) {
  //Generate pagination view.
  var paginationView = _views.Views.renderPaginationView(curPage, totalPageCount); //Insert pagination view into its container.


  paginationViewContainer.innerHTML = paginationView; //Add Event Listener

  paginationViewContainer.querySelector('.pagination__main').addEventListener('click', paginationEvtCallback);
};

var loadTrackView = function loadTrackView(pageNo, parentViewLoaderCallback) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _loader.Loader.showLoader('Please wait...'); //Get the target album clicked using event bubbling.


              targetEl = e.target;

              while (!targetEl.classList.contains('albumItem') && targetEl.tagName !== 'BODY') {
                targetEl = targetEl.parentElement;
              }

              if (targetEl.classList.contains('albumItem')) {
                _context.next = 6;
                break;
              }
            ...
            case 6:
              _context.next = 8;
              return _api.API.getAlbum(targetEl.dataset.uid);

            case 8:
              res = _context.sent;
              //Change page title
              changeDocTitle(res.data.data.doc.name); //Add 1 sec latency in case the loading of data finishes before the loader animation.

              _Utils.Utils.dispatchTimer(function () {
                //Hide the loading screen.
                _loader.Loader.hideLoader(); //Clear the previous page view.


                clearPageView(); //Set the active page id.

                _views.Views.activePage = _Utils.Utils.getPageId.tracks; //Render track list view.

                contentViewContainer.innerHTML = _views.Views.renderTrackListView(res.data.data.doc); //Render active track view.

                _views.Views.renderActiveTrackView(); //Add back button event listener


                contentViewContainer.querySelector('#tracksViewBackBtn').addEventListener('click', function () {
                  return parentViewLoaderCallback(pageNo);
                }); //Add event listener to each of the track element.

                contentViewContainer.querySelectorAll('.trackItem').forEach(function (el) {
                  return el.addEventListener('click', loadPlayer(res.data.data.doc));
                });
              }, 1000);
            ...
            case 13:
              ...
              //Hide the loading screen.
              _loader.Loader.hideLoader(); //Show the error message.


              _alert.Alert.showAlert('error', 'Failed to load the page! Please try again. 😨😨');
...
var loadAlbumView = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            sidebarCloseEvtCallback(); //Mark the albums tab as active.

            toggleActiveTab('Albums'); //Clear previous page view.

            clearPageView(); //Set the active page id.

            _views.Views.activePage = _Utils.Utils.getPageId.albums; //Start by displaying the loading screen.

            _loader.Loader.showLoader('Please wait...'); //Fetch the data.


            _context2.next = 9;
            return _api.API.getAlbums(pageNo);
          ...
          case 9:
            ...
            _Utils.Utils.dispatchTimer(function () {
              //Hide the loading screen.
              _loader.Loader.hideLoader(); //Render heading view only if albums exist.


              if (res.data.data.docs.length > 0) headingViewContainer.innerHTML = _views.Views.renderHeadingView('Albums'); //Render albums view.

              contentViewContainer.innerHTML = _views.Views.renderAlbumView(res.data.data.docs); //Add the event listener to the album cards.

              contentViewContainer.querySelectorAll('.albumItem').forEach(function (el) {
                return el.addEventListener('click', loadTrackView(pageNo, loadAlbumView));
              }); //Render other required views

              var totalPageCount = Math.ceil(res.data.total / 12);
  ...
  return function loadAlbumView() {
    return _ref2.apply(this, arguments);
  };
}();

var loadSearchView = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            pageNo = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : 1;
            ...
            _views.Views.activePage = _Utils.Utils.getPageId.search; //Start by displaying the loading screen.

            _loader.Loader.showLoader('Please wait...'); //Start search request.


            if (!query) query = document.body.dataset.qstr;
            _context3.next = 10;
            return _api.API.getAlbumSearchResult(query, pageNo);

          case 10:
            res = _context3.sent;
            //Chnage page title
            changeDocTitle('Search Result'); //Add 1 sec latency in case the loading of data finishes before the loader animation.
            ...
            _Utils.Utils.dispatchTimer(function () {
              ...
              if (res.data.data.albums.length > 0) headingViewContainer.innerHTML = _views.Views.renderHeadingView("Results (".concat(res.data.total, ") :)")); //Render the searched albums view.

              contentViewContainer.innerHTML = _views.Views.renderAlbumSearchView(res.data.data.albums); //Add event listener to the album cards.

              contentViewContainer.querySelectorAll('.albumItem').forEach(function (el) {
                return el.addEventListener('click', loadTrackView(pageNo, loadSearchView));
              }); //Add event listener to the back button.

              contentViewContainer.querySelector('#searchViewBackBtn').addEventListener('click', function () {
                loadAlbumView();
              }); //Render pagination.
  ...
  return function loadSearchView() {
    return _ref3.apply(this, arguments);
  };
}(); //TODO: Implement index page view


var loadIndexView = function loadIndexView() {
  //Close the sidebar manually.
  sidebarCloseEvtCallback(); //Mark the active tab or page.

  toggleActiveTab('Home'); //Clear the previous tab or page view.

  clearPageView(); //Set active page id.

  _views.Views.activePage = _Utils.Utils.getPageId.index;
}; //TODO: Implement user account page view


var loadUserAccountView = function loadUserAccountView() {
  //Close the sidebar manually.
  sidebarCloseEvtCallback(); //Mark the active tab or page.

  toggleActiveTab('MyAccount'); //Clear the previous tab or page view.

  clearPageView(); //Set Active Page Id

  _views.Views.activePage = _Utils.Utils.getPageId.user_account;
...
if (passResetVerifyForm) {
  passResetVerifyForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 5;
              return _authenticator.Authenticator.forgotPassword(email.value);
...
if (passResetForm) {
  passResetForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 6;
              return _authenticator.Authenticator.resetPassword(e.target.dataset.rtkn, pass.value, cPass.value);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 6;
              return _authenticator.Authenticator.login(email.value, pass.value);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                e.preventDefault();
                _context8.next = 3;
                return _authenticator.Authenticator.logout();
...
if (signupVerifyForm) {
  signupVerifyForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 5;
              return _authenticator.Authenticator.signupVerify(email.value);
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 7;
              return _authenticator.Authenticator.signup(e.target.dataset.uid, e.target.dataset.vtkn, name.value, pass.value, cPass.value);
